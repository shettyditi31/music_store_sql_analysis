...
--who is the best customer? customer who has spent the most money will be declared as the best customer.--
...
--write a query to return the email, first_name, last_name, and genre of all rock music listeners.--
--return your list ordered alphabetically by mail starting with A--
...
--we want to determine the most popular genre in for each country. we determine the most popular genre as the one with highest amount of purchase.--
...
--write a query that determines the customer that has spent the most money on music for each country--
